...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Dis.setForeground(new java.awt.Color(0, 102, 204));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/supermarket/photo_2023-05-24_18-26-39 (2).jpg"))); // NOI18N
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    ...
                                                    .addComponent(Dis, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(34, 34, 34)
...
if (UpdateQty > 0) {
    count++;        
    double originalPrice = Double.parseDouble(Price.getText());
    double discountPercentage = Double.parseDouble(Dis.getText());
    double discountedPrice = applyDiscount(originalPrice, discountPercentage);
    Total = discountedPrice * (Double.valueOf(Qty.getText()));
    NetTotal = NetTotal + Total;
    
    if (count == 1) {
        BillTxt.setText(BillTxt.getText() + "\t Welcome to SuperMarket\n\t************YOUR BILL*************\n" + " ID    \tNAME    \tPRICE    \tQUANTITY    \tDISCOUNT    \tTOTAL\n " + " " + count + "      \t" + Prod.getText() + "      \t" + Price.getText() + "         \t" + Qty.getText() + "      \t" + Dis.getText()+"\t"+Total + "\n" );
    }
    if (count > 1) {
        BillTxt.setText(BillTxt.getText() + " " + count + "      \t" + Prod.getText() + "      \t" + Price.getText() + "         \t" + Qty.getText() + "      \t" + Dis.getText()+"\t"+ Total + "\n");
    }
